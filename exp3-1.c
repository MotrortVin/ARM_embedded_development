...
#include "interrupt.h"
#include "uart.h"
#include "hw_ints.h"//for IntEnable(INT_UART0);
#include <string.h>   //some thing for string and more
#include <stdio.h>
...
void 		UARTStringPut(uint8_t *cMessage);      //for 3-4
void 		UARTStringGet(uint32_t ui32Base,char *cMessage,const char Iden);    //for 3-4
...
char uart_receive_string[100];  //just for text3-4
uint8_t using_char;      //just for text3-2
int32_t uart0_int_status;  //just_for text3-3
char second1[5];
char second2[5];
char minute1[5];
char minute2[5];
...
{	
  ...
  SysTickPeriodSet(ui32SysClock/SYSTICK_FREQUENCY);
	...
	//for text 3-3 youshould put it in the end
  IntEnable(INT_UART0);
	...
	{
/***********************************************************************************************************************/
/*                                3.2 output what PC have input(UART ECHO)                                             */
/***********************************************************************************************************************/
/*
		if  (UARTCharsAvail(UART0_BASE))
    {
			using_char = UARTCharGetNonBlocking(UART0_BASE);
		  UARTCharPut(UART0_BASE,using_char);		
		}
...
/***********************************************************************************************************************/
/*                                3.45 output your class and student number                                            */
/***********************************************************************************************************************/
		if ((strcmp(uart_receive_string,"at+class")==0) || (strcmp(uart_receive_string,"AT+CLASS")==0))
		{
...
//for text 3-4
void UARTStringGet(uint32_t ui32Base,char *cMessage,const char Iden)	//Iden means the end of the string
{
    while(1)
	{
...
/***********************************************************************************************************************/
/*                                    3.1 output "hello world" when reset                                              */
/***********************************************************************************************************************/
void S800_UART_Init(void)
{
...
/***********************************************************************************************************************/
/*                             3.3 output what PC have input(interrupt UART ECHO)                                      */
/***********************************************************************************************************************/
/*
...
*/
/***********************************************************************************************************************/
/*                                3.4 output your class and student number                                             */
/***********************************************************************************************************************/
/*
...
void UART0_Handler(void)
{
  ...
  UARTIntClear(UART0_BASE, uart0_int_status);					//Clear the asserted interrupts
	...
	while(UARTCharsAvail(UART0_BASE))
	{
	   UARTStringGet(UART0_BASE,uart_receive_string,'.'); //get the string from PC,and put '.' as an end
  }
}
